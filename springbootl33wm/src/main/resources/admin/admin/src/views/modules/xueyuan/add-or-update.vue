<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="学院地址" prop="xueyuandizhi">
          <el-input v-model="ruleForm.xueyuandizhi" 
              placeholder="学院地址" clearable  :readonly="ro.xueyuandizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="学院地址" prop="xueyuandizhi">
              <el-input v-model="ruleForm.xueyuandizhi" 
                placeholder="学院地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	xueyuandizhi : false,
      ...
      rules: {
          xueyuanzhanghao: [
                { required: true, message: '学院账号不能为空', trigger: 'blur' },
          ],
          mima: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.youxiang = true;
          ...
          if(o=='xueyuandizhi'){
            this.ruleForm.xueyuandizhi = obj[o];
	    this.ro.xueyuandizhi = true;
            continue;
          }
        }
      }

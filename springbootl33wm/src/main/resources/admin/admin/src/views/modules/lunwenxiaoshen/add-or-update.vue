<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="论文题目" prop="lunwentimu">
          <el-input v-model="ruleForm.lunwentimu" 
              placeholder="论文题目" clearable  :readonly="ro.lunwentimu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="论文题目" prop="lunwentimu">
              <el-input v-model="ruleForm.lunwentimu" 
                placeholder="论文题目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="论文类型" prop="lunwenleixing">
          <el-input v-model="ruleForm.lunwenleixing" 
              placeholder="论文类型" clearable  :readonly="ro.lunwenleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="论文类型" prop="lunwenleixing">
              <el-input v-model="ruleForm.lunwenleixing" 
                placeholder="论文类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="论文副标题" prop="lunwenfubiaoti">
          <el-input v-model="ruleForm.lunwenfubiaoti" 
              placeholder="论文副标题" clearable  :readonly="ro.lunwenfubiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="论文副标题" prop="lunwenfubiaoti">
              <el-input v-model="ruleForm.lunwenfubiaoti" 
                placeholder="论文副标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作者署名" prop="zuozheshuming">
          <el-input v-model="ruleForm.zuozheshuming" 
              placeholder="作者署名" clearable  :readonly="ro.zuozheshuming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="作者署名" prop="zuozheshuming">
              <el-input v-model="ruleForm.zuozheshuming" 
                placeholder="作者署名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="时间" prop="shijian">
          <el-input v-model="ruleForm.shijian" 
              placeholder="时间" clearable  :readonly="ro.shijian"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.lunwenwenjian" label="论文文件" prop="lunwenwenjian">
          <file-upload
          tip="点击上传论文文件"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.lunwenwenjian?ruleForm.lunwenwenjian:''"
          @change="lunwenwenjianUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.lunwenwenjian" label="论文文件" prop="lunwenwenjian">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.lunwenwenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='lunwentimu'){
            this.ruleForm.lunwentimu = obj[o];
	    this.ro.lunwentimu = true;
            continue;
          }
          if(o=='lunwenleixing'){
            this.ruleForm.lunwenleixing = obj[o];
	    this.ro.lunwenleixing = true;
            continue;
          }
          if(o=='lunwenfubiaoti'){
            this.ruleForm.lunwenfubiaoti = obj[o];
	    this.ro.lunwenfubiaoti = true;
            continue;
          }
          if(o=='zuozheshuming'){
            this.ruleForm.zuozheshuming = obj[o];
	    this.ro.zuozheshuming = true;
            continue;
          }
          if(o=='zhuanye'){
	    ...
	    this.ro.shijian = true;
          ...
          if(o=='lunwenwenjian'){
            this.ruleForm.lunwenwenjian = obj[o];
	    this.ro.lunwenwenjian = true;
            continue;
          }
          if(o=='jiaoshigonghao'){
	...
	if(this.ruleForm.lunwenwenjian!=null) {
		this.ruleForm.lunwenwenjian = this.ruleForm.lunwenwenjian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `lunwenxiaoshen/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.lunwenxiaoshenCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    lunwenwenjianUploadChange(fileUrls) {
	this.ruleForm.lunwenwenjian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{

      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='xueyuan'" class="input-group">
			   <div class="label">学院账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xueyuanzhanghao" class="input" type="text" placeholder="学院账号">
			   </div>
			 </div> -->
			<el-form-item label="学院账号" class="input" v-if="tableName=='xueyuan'">
			  <el-input v-model="ruleForm.xueyuanzhanghao" autocomplete="off" placeholder="学院账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xueyuan'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<!-- <div v-if="tableName=='xueyuan'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.xueyuanmingcheng" class="input" type="text" placeholder="学院名称">
			   </div>
			 </div> -->
			<el-form-item label="学院名称" class="input" v-if="tableName=='xueyuan'">
			  <el-input v-model="ruleForm.xueyuanmingcheng" autocomplete="off" placeholder="学院名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xueyuan'" class="input-group">
			...
			<el-form-item label="负责人" class="input" v-if="tableName=='xueyuan'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='xueyuan'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='xueyuan'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xueyuan'" class="input-group">
			   <div class="label">学院地址</div>
			   <div class="input-container">
			     <input v-model="ruleForm.xueyuandizhi" class="input" type="text" placeholder="学院地址">
			   </div>
			 </div> -->
			<el-form-item label="学院地址" class="input" v-if="tableName=='xueyuan'">
			  <el-input v-model="ruleForm.xueyuandizhi" autocomplete="off" placeholder="学院地址"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.xueyuanmingcheng) && `xueyuan` == this.tableName){
        this.$message.error(`学院名称不能为空`);
        return
      }
      if(`xueyuan` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20220104/93dce75bb39449e8b8729467fea606fa.jpg);
